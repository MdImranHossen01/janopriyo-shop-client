...
const PlantDetails = () => {
  ...
  if (plant === null) return <p>Plant not found (404)</p>;

  if (!plant || typeof plant !== 'object') return <p>Loading...</p>;

  const { name, description, category, quantity, price, seller, image } = plant;
